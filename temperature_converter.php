...
<html lang="en">
  <head>
    ...
    <title>Tempereture Convert</title>
  ...
  <div class="container-fluid">
   ...
   <!-- Navbar -->
        ...
        <form  action="temp_convert_validation.php" method="POST" class="w-50 mx-auto mt-5 shadow-lg p-3 mb-5 bg-white rounded">
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Your Temperature</label>
            <input type="number" name="temp_input" class="form-control" id="" placeholder="Enter Your Number In Temperature">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Your Temperature</label>
            <select class="form-select" name="temp_select" aria-label="Default select example">
