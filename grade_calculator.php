...
<html lang="en">
  ...
  <div class="container-fluid">
   ...
   <!-- Navbar -->
        ...
        <form  action="grade_calculator_value.php" method="POST" class="w-50 mx-auto mt-5 shadow-lg p-3 mb-5 bg-white rounded">
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Your Mark</label>
            <input type="number" name="your_marks" class="form-control" id="" placeholder="Enter Your Marks Here">
        </div>
        <div class="mb-3">
