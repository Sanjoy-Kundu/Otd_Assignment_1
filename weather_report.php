...
<html lang="en">
  ...
  <div class="container-fluid">
   ...
   <!-- Navbar -->
        <form  action="weather_report_post.php" method="POST" class="w-50 mx-auto mt-5 shadow-lg p-3 mb-5 bg-white rounded">
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Write Your Weather</label>
            <input type="number" name="temperature" class="form-control" id="" placeholder="Enter Your Temperature here">
        </div>
        <div class="mb-3">
