...
<html lang="en">
  ...
  <div class="container-fluid">
   ...
   <!-- Navbar -->
        <form  action="comparison_tool_post.php" method="POST" class="w-50 mx-auto mt-5 shadow-lg p-3 mb-5 bg-white rounded">
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">First Number</label>
            <input type="number" name="first" class="form-control" id="" placeholder="Enter Your First Number">
        </div>
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Second Number</label>
            <input type="number" name="second" class="form-control" id="" placeholder="Enter Your Second Number">
        </div>
        <div class="mb-3">
